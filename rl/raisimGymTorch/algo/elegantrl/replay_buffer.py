...
#         self.device = 'cpu'  # Numpy does not use GPU
...
#     def sample_for_per(self, batch_size: int) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
#         beg = -self.max_size
