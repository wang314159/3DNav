...
class RewardAnalyzer:
    ...
    def analyze_and_plot(self, step):
        ...
        for data_id in range(len(self.data_tags)):
            self.reward_dict[self.data_tags[data_id]+'/mean'] = self.data_mean[data_id]
            self.reward_dict[self.data_tags[data_id]+'/std'] = data_std[data_id]
            self.reward_dict[self.data_tags[data_id]+'/min'] = self.data_min[data_id]
            self.reward_dict[self.data_tags[data_id]+'/max'] = self.data_max[data_id]
